  ...
  <div class="container px-6 py-8 mx-auto">
    ...
    >
      <router-link
        target="_blank"
        to="/addmenu"
        class="block mt-10 w-40 px-4 py-3 font-medium tracking-wide text-center capitalize transition-colors duration-300 transform bg-lime-400 rounded-[14px] hover:bg-lime-600 focus:outline-none focus:ring focus:ring-teal-300 focus:ring-opacity-80"
      >
        Add Item
      </router-link>
    </div>
